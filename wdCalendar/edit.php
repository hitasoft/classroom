...
if(!$_GET["amid"]) die('An unexpected error has occurred. User could not be identified.');
?>
        ...
        $(document).ready(function() {
            ...
            $("#Deletebtn").click(function() {
                 if (confirm("Are you sure to remove this event")) {  
                    var param = [{ "name": "calendarId", value: 8}, {"name":"aMid",value:user.amid}];                
...
<?php echo isset($event)?$event->Description:""; ?>
          ...
          <input id="aMid" name="aMid" type="hidden" value="<?=$_GET['amid']?>" />           
        </form>         
      </div>         
    </div>
  </body>
