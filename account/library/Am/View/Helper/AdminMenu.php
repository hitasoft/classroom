    ...
    public function renderMenu(Zend_Navigation_Container $container, $options = array()) {
        ...
        foreach ($container as $page)
        {
            ...
            if (!($page->hasChildren() && !$subMenu)) {
                $html .= sprintf('<li><div class="menu-glyph"%s><div class="menu-glyph-delimeter"><a id="%s" href="%s" class="%s" target="%s">%s</a></div></div>%s</li>',
...
CUT;
    ...
    protected function renderSubMenu(Zend_Navigation_Page $page) {
        ...
        foreach ($page as $subPage)
        {
            ...
            $html .= sprintf('<li><div class="menu-glyph" %s><a id="%s" href="%s" class="%s" target="%s">%s</a></div></li>',
