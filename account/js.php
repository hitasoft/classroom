...
switch ($_GET['js'])
{
    case 'admin':
        ...
        $js = array(
            'application/default/views/public/js/jquery/jquery.js',
            'application/default/views/public/js/jquery/jquery.outerClick.js',
            'application/default/views/public/js/jquery/jquery.form.js',
            'application/default/views/public/js/jquery/jquery.validate.js',
            'application/default/views/public/js/jquery/jquery.json.js',
