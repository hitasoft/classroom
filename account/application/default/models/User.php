...
class User extends Am_Record_WithData {
    ...
    {
        if ($this->getDi()->config->get('changepass_mail')) {
            $tpl = $this->getDi()->emailTemplateTable->findFirstExact('changepass_mail', $this->lang);
            $mailTpl = Am_Mail_Template::createFromEmailTemplate($tpl);
            $mailTpl->setUser($this);
            $mailTpl->setPassword($this->getPlaintextPass());
            $mailTpl->send($this);
        }
    }
