...
class Am_Paysystem_InetCash extends Am_Paysystem_Abstract
{
    ...
    public function _process(Invoice $invoice, Am_Request $request, Am_Paysystem_Result $result)
    {
        ...
        //$a = new Am_Paysystem_Action_Redirect($header['location']);
        //$result->setAction($a);
    ...
    public function directAction(Am_Request $request, Zend_Controller_Response_Http $response, array $invokeArgs)
    {
        ...
        if($actionName == 'ipn')
        {
            ...
            if($request->get('art') == 'request')
            {
                ...
                $params['compain_id'] = '';
                $params['ipadresse'] = $user->remote_addr;
            ...
            $shopid = $request->get('shopid');
            $this->invoice = array_shift(Am_Di::getInstance()->invoiceTable->findByPublicId($shopid));
...
{       
    ...
    {
        return "traceno-".$this->request->get('traceno')."-belegnr-".$this->request->get('belegnr');
    }
