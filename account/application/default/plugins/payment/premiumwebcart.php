...
class Am_Paysystem_Premiumwebcart extends Am_Paysystem_Abstract{
    ...
    {
        $form->addText('merchant_id')->setLabel(array('Merchant ID', 'Your PremiumWebCart Merchant ID'));
        $form->addText('api_signature', array('size' => 60))->setLabel(array('API Sinature', 'You can get it from Home >> Cart Settings >> Advance Integration >> API Integration'));
    }
...
4. Set Premium Web Cart Instant Payment Notification URL to $rootURL/payment/premiumwebcart/ipn  
