...
class Am_Paysystem_MikroOdeme extends Am_Paysystem_Abstract
{
    ...
    {
        $form->addText('user_code')->setLabel(array('User Code', 'Refers to the partner company number given by MO'));
        $form->addText('pin')->setLabel(array('Pin', 'Refers to the partner company’s API Key/PIN given by MO'));
    }
