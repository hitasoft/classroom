...
class Am_Paysystem_Metacharge extends Am_Paysystem_Abstract
{
    ...
    public function _initSetupForm(Am_Form_Setup $form)
    {
        $form->addText("installation_id", array('size' => 15))
            ->setLabel(array("Your Metacharge installation ID",
                "refer to Merchant Extranet: Account Management > Installations"))
            ->addRule('required');
        $form->addText("auth_username", array('size' => 15))
            ->setLabel(array("Response HTTP Auth Username",
            "Metacharge PRN response authorisation username"))
            ->addRule('required');
        $form->addPassword("auth_password", array('size' => 15))
            ->setLabel(array("Response HTTP Auth Password",
...
- Response URL: The URL where you want the PRN to be sent: $rootURL/payment/metacharge/ipn
...
- return URL: $rootURL/payment/metacharge/thanks
