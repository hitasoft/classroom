...
class Am_Paysystem_Paypoint extends Am_Paysystem_Abstract
{
    ...
    public function _initSetupForm(Am_Form_Setup $form)
    {
        ...
        $form->addText('remote_password', array('size' => 30))
            ->setLabel(array('Remote Password', 'Please see readme below'));
        $form->addText('digestkey', array('size' => 30))
            ->setLabel(array('Digest Key', 'Created from within the PayPoint.net Merchant Extranet'));
...
class Am_Paysystem_Transaction_Paypoint extends Am_Paysystem_Transaction_Incoming
{
    ...
    {
        list($invoice, ) = split('_', $this->request->getFiltered('trans_id'));
        return $invoice;
    }
