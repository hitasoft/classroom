...
';
    ...
    function createForm()
    {
        ...
        $form->addText('comment', array('style'=>'width:95%'))->setLabel(array(___('Comment'), ___('for your reference')))->addRule('required');
        ...
        $fs->addText('view[title]', array('style'=>'width:95%'))->setLabel(___('Title'));
