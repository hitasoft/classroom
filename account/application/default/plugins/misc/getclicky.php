...
//        print_rre($this->id);
    ...
    function onSetupForms(Am_Event_SetupForms $forms)
    {
        ...
        $form->addInteger('getclicky_id')
             ->setLabel(array("GetClicky Account Id"
        ));
    }
    ...
    function getTrackingCode()
    {
        return <<<CUT
<!-- getclicky code -->
<a title="Real Time Analytics" href="http://getclicky.com/66502033" rel="nofollow"><img alt="Real Time Analytics" src="//static.getclicky.com/media/links/badge.gif" border="0" width="1" height="1"/></a>
