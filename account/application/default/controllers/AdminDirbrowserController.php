...
class AdminDirbrowserController extends Am_Controller
{
    ...
    {
        $dirOrig = $this->getRequest()->getParam('dir', ROOT_DIR);
        $dirOrig = is_dir($dirOrig) ? $dirOrig : ROOT_DIR;
    ...
    public function guessUrl($dir)
    {
        ...
        $rootUrlMeta = parse_url($this->getDi()->config->get('root_url'));
