...
class AdminImportController extends Am_Controller
{
    ...
    {
        if($this->dataSource) unset($this->dataSource);
    ...
    protected function addImportFields()
    {
        ...
        $this->addImportField(new Import_Field_UserLogin('login', ___('Login'), true));
        ...
        //Subscription Fields
        $this->addImportField(new Import_Field_SubProduct('product_id', ___('Subscription'), true), self::FIELD_TYPE_SUBSCRIPTION);
        ...
        $this->addImportField(new Import_Field_Date('begin_date', ___('Subscription Begin Date'), true), self::FIELD_TYPE_SUBSCRIPTION);
        $this->addImportField(new Import_Field_Date('expire_date', ___('Subscription Expire Date'), true), self::FIELD_TYPE_SUBSCRIPTION);
