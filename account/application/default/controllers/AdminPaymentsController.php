...
abstract class Am_Grid_Filter_Payments_Abstract extends Am_Grid_Filter_Abstract
{
    ...
    protected function applyFilter()
    {
        ...
        if(@$filter['paysys_id'])
            $q->addWhere('paysys_id=?', $filter['paysys_id']);
    ...
    public function renderInputs()
    {
        ...
        $paysysOptions = array('' => '-' . ___('Filter by Paysystem') . '-');
        ...
        return <<<CUT
<select name="{$prefix}_filter[product_id]" style="width:160px">
$pOptions
</select>
<select name="{$prefix}_filter[paysys_id]" style="width:160px">
$paysysOptions
</select>
<br />
$dSelect
...
<br />
<input type="text" name="{$prefix}_filter[text]" value="{$filter['text']}" style="width:160px" />
