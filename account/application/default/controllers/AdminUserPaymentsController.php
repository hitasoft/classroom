...
class AdminUserPaymentsController extends Am_Controller 
{
    ...
    public function resendPaymentLinkAction()
    {
        ...
        $message = $form->addTextarea('message', array('style'=>'width:95%'))->setLabel(array(___('Message'), ___('will be included to email to user')));
    ...
    public function addInvoiceAction()
    {
        ...
        $comment = $form->addText('comment', array('style'=>'width:95%'))->setLabel(array(___('Comment'), ___('for your reference')));
        ...
        $form->addScript()->setScript('
            $("#add-invoice-action").change(function(){
                $("#add-invoice-receipt").closest("div.row").toggle($(this).val() == "pending-payment")
                $("#add-invoice-due").closest("div.row").toggle($(this).val() == "pending-send")
                $("#add-invoice-message").closest("div.row").toggle($(this).val() == "pending-send")
                $("[name=invoice_pay_link]").closest("div.row").toggle($(this).val() == "pending-send")
            }).change();
    ...
    public function createAccessForm()
    {
        ...
        if (!$form)
        {
            ...
            $sel = $form->addSelect('product_id', array('style' => 'width:90%'));
            ...
            $form->addText('comment', array('style' => 'width:90%'));
