...
class Am_Form_Admin_CouponBatch extends Am_Form_Admin {
    ...
    function init()
    {
        ...
        $this->addTextarea('comment', array('style'=>'width:95%'))
...
CUT
    ...
    public function detailAction()
    {
        ...
        $grid->addGridField(new Am_Grid_Field_Expandable('used_count', ___('Used For'), false))
    ...
    public function getUsedCount($obj)
    {
        ...
        $wrap .= '<table class="grid">';
        $wrap .= '<tr><th>' . ___('User') . '</th><th>' . ___('Date/Time') . '</th><th>' . ___('Receipt#') . '</th><th>' . ___('Amount') . '</th></tr>';
        $wrap .= '%s</table>';
