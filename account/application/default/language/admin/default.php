<?php
 return array (
  ...
  '%public_id% will be replaced with real public id of invoice, %receipt_id% will be replaced with payment receipt' => '%public_id% will be replaced with real public id of invoice, %receipt_id% will be replaced with payment receipt',
  '%s Plugins' => '%s Plugins',
...
if set to Yes, don\'t ask customer - always remember',
  ...
  'Amount of all payments made by user' => 'Amount of all payments made by user',
  'Api Key' => 'Api Key',
  'Apply Tax?' => 'Apply Tax?',
  'Apply to recurring?
...
It could not be changed if there are any invoices in database',
  ...
  'By default each invoice will be set as "Not Apprved" ' => 'By default each invoice will be set as "Not Apprved" ',
...
how many times coupon can be used',
  ...
  'Credit Card Expiration Notice' => 'Credit Card Expiration Notice',
  'Credit Card Rebill Failed' => 'Credit Card Rebill Failed',
  'Credit Card Rebill Successfull' => 'Credit Card Rebill Successfull',
  'Currency' => 'Currency',
...
if there is only one billing plan only terms will be listed' => 'Do not show \'Default billing plan\' on form
...
enter cost of 1 (one) %s',
  'Expiration date of latest subscription' => 'Expiration date of latest subscription',
...
(max filesize %s)',
  ...
  'Filename' => 'Filename',
  'Filename for invoice' => 'Filename for invoice',
  'Files' => 'Files',
...
and show \'Shopping Cart\' button' => 'Hide \'Add/renew Subscription\' button
...
* subscription expiration notices',
  'It can contain html markup' => 'It can contain html markup',
  ...
  'Manually Approve New Members' => 'Manually Approve New Members',
...
will occur at the Second Price',
  'Rebills Next 30 days' => 'Rebills Next 30 days',
  ...
  'Recurring' => 'Recurring',
  'Recurring Cancelled' => 'Recurring Cancelled',
...
keep empty for redirect to site homepage',
  'Redirect to signup cart page on default' => 'Redirect to signup cart page on default',
  'Referer' => 'Referer',
  'Referrer' => 'Referrer',
  'Refund' => 'Refund',
...
cookie will be stored for ... days',
  ...
  'Reports' => 'Reports',
  'Require Approval Only If Invoice Has These Products' => 'Require Approval Only If Invoice Has These Products',
...
for new members' => 'Send Approval Notification to admin
for new members',
  ...
  'Send Credit Card Rebill Stats to Admin' => 'Send Credit Card Rebill Stats to Admin',
...
how long (in days) calculate commission for referred affiliate (default: 0 - forever)',
  ...
  'Username of Source User' => 'Username of Source User',
...
audio formats that <a href="%s" target="_blank">supported by flowplayer</a>' => 'Video/Audio File
(max upload size %s)
You can use this feature only for video and
...
and template filename must start with [signup]',
  ...
  'don\'t enable it if you have huge members base already' => 'don\'t enable it if you have huge members base already',
  ...
  'manually approve all new members (first payment)' => 'manually approve all new members (first payment)',
  'minutes deny access for user and %sdo the following%s' => 'minutes deny access for user and %sdo the following%s',
