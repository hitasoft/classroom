...
class Am_Paysystem_Securepaycomau extends Am_Paysystem_CreditCard
{
    ...
    {
        $form->addText("merchant_id")->setLabel(array('Merchant ID', '5 or 7-character merchant ID supplied by SecurePay'));
        $form->addText("password")->setLabel(array('Payment password','Password used for authentication of the merchant\'s request message, supplied by SecurePay'));
