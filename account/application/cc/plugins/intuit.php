...
class Am_Paysystem_Intuit extends Am_Paysystem_CreditCard
{
    ...
    protected function _initSetupForm(Am_Form_Setup $form)
    {
        $form->addText('appLogin', array('size' => 40))
            ->setLabel(array('Your AppLogin',
                'from <a target="_blank" href="https://appreg.intuit.com">https://appreg.intuit.com</a>'))
            ->addRule('required');
        
        $form->addText('connectionTicket', array('size' => 40))
            ->setLabel(array('Your Connection Ticket',
                'you can get it for instruction <a target="_blank" href="'.self::URL_INSTRUCTION.'">here</a>'))
            ->addRule('required');
...
To configure the plugin:
 ...
 1. register and configure your Intuit QuickBooks Merchant Service account on the instruction here <a target='_blank' href='$link'>$link</a>
