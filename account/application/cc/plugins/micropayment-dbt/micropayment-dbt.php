...
CUT;
    ...
    {
        return new Am_Controller_CreditCard_MicropaymentDbt($request, $response, $invokeArgs);
    }
...
class Am_Controller_CreditCard_MicropaymentDbt extends Am_Controller_CreditCard
{
