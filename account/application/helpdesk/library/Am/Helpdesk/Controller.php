...
class Am_Helpdesk_Controller extends Am_Controller
{
    ...
    {
        return sprintf('<td><a href="javascript:;" class="am-helpdesk-insert-snippet" data-snippet-content="%s">%s</a></td>',
    ...
    {
        return sprintf('<td><a href="javascript:;" class="am-helpdesk-insert-faq" data-faq-content="%s">%s</a></td>',
    ...
    {
        return sprintf('<td><a href="javascript:;" class="am-helpdesk-assign" data-admin_id="%s">%s</a></td>',
    ...
    {
        return sprintf('<td><a href="javascript:;" class="am-helpdesk-edit-category" data-category_id="%s">%s</a></td>',
            $this->getDi()->app->obfuscate($record->pk()),
            Am_Controller::escape($record->title));
    }
    ...
    private function getReplyForm($ticket, $message = null, $type = 'message')
    {
        ...
        $form->addTextarea('content', array('rows' => 15, 'class' => 'no-label', 'style' => 'width:95%'))
            ->setValue($content);
